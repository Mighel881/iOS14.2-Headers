...
typedef struct {
	...
	SCD_Struct_VC120 report;
	SCD_Struct_VC123 dropAck;
	SCD_Struct_VC122) codecRateChange;
} SCD_Struct_VC124;
...
typedef struct VCMediaStreamTransportSetupInfo {
	...
	/*function pointer*/void* ;
	SCD_Struct_VC151 socketInfo;
	SCD_Struct_VC153 ipInfo;
	SCD_Struct_VC152 transportStreamInfo;
	id nwConnection;
...
typedef struct tagWRMMetricsInfo {
	...
	SCD_Struct_VC179 wrmMetricsReportingContext;
