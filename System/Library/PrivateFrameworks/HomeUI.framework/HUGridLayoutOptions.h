...
@property (nonatomic,copy) HUGridWelcomeUIBannerCellLayoutOptions * welcomeUIBannerCellOptions;                    //@synthesize welcomeUIBannerCellOptions=_welcomeUIBannerCellOptions - In the implementation block
...
-(void)setWelcomeUIBannerCellOptions:(HUGridWelcomeUIBannerCellLayoutOptions *)arg1 ;
