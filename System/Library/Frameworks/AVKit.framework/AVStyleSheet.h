...
@interface AVStyleSheet : NSObject {
	...
	CGSize _audioRoutePickerFullScreenSize;
...
@property (nonatomic,readonly) CGSize audioRoutePickerFullScreenSize;                                                   //@synthesize audioRoutePickerFullScreenSize=_audioRoutePickerFullScreenSize - In the implementation block
