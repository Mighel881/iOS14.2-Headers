...
@class VUIPlayer, TVPStateMachine, VideosExtrasContext, UIViewController, AVExternalPlaybackController, NSDictionary, VideosExtrasPresenter, VUINowPlayingFeatureMonitor, UIButton, VUIPostPlayView, NSDate, NSNumber, VUIVideoAdvisoryLogoImageDownloader, UIImage, VUIVideoAdvisoryView, VUIProductPlacementView, NSString;
