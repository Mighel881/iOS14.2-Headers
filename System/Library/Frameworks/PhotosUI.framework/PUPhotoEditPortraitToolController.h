...
@class CEKApertureButton, PXUIButton, UIView, NSMutableArray, _PULightingGradientView, CEKLightingNameBadge, NSArray, CEKSlider, PUPhotoEditApertureToolbar, PFCoalescer, NSDictionary, NSNumber, NSMutableDictionary, CEKLightingControl, NSString;
