...
typedef struct {
	SCD_Struct_BW52 lastWideSpherePos;
	SCD_Struct_BW52 lastTeleSpherePos;
	SCD_Struct_BW52 currentTeleSpherePos;
	SCD_Struct_BW52 previousTeleSpherePos;
...
typedef struct {
	SCD_Struct_BW67 modelInfo;
	unsigned frameId;
	unsigned numFaces;
	SCD_Struct_BW69 faces[10];
	unsigned numObjects;
	SCD_Struct_BW70 objects[10];
	unsigned numSaliencyObjects;
	SCD_Struct_BW70 saliencyObjects[1];
	SCD_Struct_BW68 saliencyHeatMap;
} SCD_Struct_BW71;
...
typedef struct {
	SCD_Struct_BW104 netInputBufferDesc[3];
	SCD_Struct_BW104 netOutputBufferDescs[3][24];
...
typedef struct {
	SCD_Struct_Fi45 field1;
	SCD_Struct_Fi45 field2;
} SCD_Struct_Fi112;
...
typedef struct {
	SCD_Struct_BW94 field1;
	SCD_Struct_Fi129 field2;
	SCD_Struct_Fi129 field3;
	SCD_Struct_Fi129 field4;
	int field5;
	BOOL field6;
	BOOL field7;
	BOOL field8;
