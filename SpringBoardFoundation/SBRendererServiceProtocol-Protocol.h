...
- (void)service_applyMaterialRecipe:(SBFCARendererImageRepresentation *)arg1 recipeName:(NSString *)arg2 weighting:(double)arg3 downsampleFactor:(double)arg4 withReply:(void (^)(IOSurface *))arg5;
