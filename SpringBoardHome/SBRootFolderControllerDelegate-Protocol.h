...
@class NSString, SBIconListView, SBIconView, SBRootFolderController, SBViewControllerTransitionContext, SBWidgetIcon, UIView, UIViewPropertyAnimator;
...
- (void)rootFolderController:(SBRootFolderController *)arg1 didInsertWidgetIcon:(SBWidgetIcon *)arg2 withReferenceIconView:(SBIconView *)arg3;
...
- (void)rootFolderControllerWillDismissPageManagement:(SBRootFolderController *)arg1 usingAnimator:(id <UIViewImplicitlyAnimating>)arg2;
- (void)rootFolderControllerWillPresentPageManagement:(SBRootFolderController *)arg1 usingAnimator:(id <UIViewImplicitlyAnimating>)arg2;
- (NSString *)rootFolderController:(SBRootFolderController *)arg1 vendorNameForAppWithBundleIdentifiers:(NSString *)arg2;
- (void)rootFolderController:(SBRootFolderController *)arg1 didEndOverscrollOnLastPageWithVelocity:(double)arg2;
