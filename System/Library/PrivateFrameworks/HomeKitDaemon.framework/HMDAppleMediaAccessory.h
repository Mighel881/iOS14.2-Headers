...
@class HMDBackingStore, HMFActivity, HMDDevice, HMDDeviceController, HMMediaDestination, HMMediaDestinationControllerData, HMFPairingIdentity, HMDRemoteLoginHandler, HMDAccessorySymptomHandler, HMFSoftwareVersion, HMFWiFiNetworkInfo, HMDTargetControlManager, HMDAccessorySettingsController, NSArray, HMDMediaDestinationManager, HMDMediaDestinationController, HMDAppleMediaAccessoryMetricsDispatcher, HMFWiFiManager, NSNotificationCenter, NSString;
