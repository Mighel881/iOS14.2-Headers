...
@protocol AVTResourceCache, AVTStickerTaskScheduler, OS_dispatch_queue, AVTAvatarRecord, AVTCacheableResource;
...
@property (nonatomic,readonly) id<AVTStickerTaskScheduler> renderingScheduler;                //@synthesize renderingScheduler=_renderingScheduler - In the implementation block
...
-(id<AVTStickerTaskScheduler>)renderingScheduler;
