...
@class FigMetalContext, FigM2MController;
...
@interface affineGPUMetal : NSObject {
	...
	* _blurRenderVertex;
	...
	CVBufferRef _intermediateOutputPixelBuffer;
...
-(int)_transformAndConvertToBT2020InputPixelBuffer:(CVBufferRef)arg1 outputPixelBuffer:(CVBufferRef)arg2 commandBuffer:(id)arg3 ;
