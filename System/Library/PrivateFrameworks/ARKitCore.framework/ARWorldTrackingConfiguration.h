...
@property (assign,getter=isAccuratePlaneExtentCheckEnabled,nonatomic) BOOL accuratePlaneExtentCheckEnabled;              //@synthesize accuratePlaneExtentCheckEnabled=_accuratePlaneExtentCheckEnabled - In the implementation block
