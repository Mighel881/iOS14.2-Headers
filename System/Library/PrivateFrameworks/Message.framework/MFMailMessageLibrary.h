...
-(void)_iterateStatement:(id)arg1 connection:(id)arg2 withProgressMonitor:(id)arg3 andRowHandler:(/*function pointer*/void*)arg4 context:(const SCD_Struct_MF5*)arg5 ;
