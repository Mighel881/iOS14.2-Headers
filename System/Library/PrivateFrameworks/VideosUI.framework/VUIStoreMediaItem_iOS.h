...
@property (assign,nonatomic) BOOL needsRentalCheckoutPriorToPlayback;                //@synthesize needsRentalCheckoutPriorToPlayback=_needsRentalCheckoutPriorToPlayback - In the implementation block
