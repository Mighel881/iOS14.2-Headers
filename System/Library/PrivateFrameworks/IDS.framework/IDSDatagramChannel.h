...
-(SCD_Struct_ID12*)_setWiFiAssist:(BOOL)arg1 ;
-(id)cachedMetadata;
-(void)readyToRead;
-(void)generateMetadataWithDatagramInfo:(SCD_Struct_ID8)arg1 options:(SCD_Struct_ID10*)arg2 currentDatagramCount:(unsigned char)arg3 totalDatagramCount:(unsigned char)arg4 byteBuffer:(SCD_Struct_ID13*)arg5 ;
