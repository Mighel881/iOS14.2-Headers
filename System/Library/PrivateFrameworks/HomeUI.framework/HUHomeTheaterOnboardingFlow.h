...
@class HMHome, NAFuture, UIViewController, NSArray, NSString;
...
@property (nonatomic,retain) NSArray * appleTVs;                                                                  //@synthesize appleTVs=_appleTVs - In the implementation block
