...
@property (nonatomic,readonly) SCD_Struct_CL26 clientLocation; 
...
-(id)initWithClientLocation:(SCD_Struct_CL26)arg1 matchInfo:(id)arg2 trustedTimestamp:(double)arg3 groundAltitude:(id)arg4 fusionInfo:(id)arg5 rawHorizontalAccuracy:(double)arg6 rawCourseAccuracy:(double)arg7 ;
-(double)altitude;
-(unsigned)integrity;
...
-(id)initWithClientLocation:(SCD_Struct_CL26)arg1 matchInfo:(id)arg2 trustedTimestamp:(double)arg3 ;
-(id)initWithClientLocation:(SCD_Struct_CL26)arg1 matchInfo:(id)arg2 ;
-(id)initWithClientLocation:(SCD_Struct_CL26)arg1 coarseMetaData:(id)arg2 ;
-(void)encodeWithCoder:(id)arg1 ;
-(double)horizontalAccuracy;
-(void)unmatch;
-(id)initWithClientLocation:(SCD_Struct_CL26)arg1 clientLocationPrivate:(SCD_Struct_CL29)arg2 ;
...
-(NSDate *)timestamp;
-(id)initWithClientLocation:(SCD_Struct_CL26)arg1 clientLocationPrivate:(SCD_Struct_CL29)arg2 coarseMetaData:(id)arg3 ;
-(SCD_Struct_CL26)clientLocation;
-(id)initWithClientLocation:(SCD_Struct_CL26)arg1 ;
-(id)initWithClientLocation:(SCD_Struct_CL26)arg1 matchInfo:(id)arg2 trustedTimestamp:(double)arg3 groundAltitude:(id)arg4 ;
-(id)copyWithZone:(NSZone*)arg1 ;
-(id)shortDescription;
-(double)distanceFromLocation:(id)arg1 ;
-(id)initWithClientLocation:(SCD_Struct_CL26)arg1 matchInfo:(id)arg2 trustedTimestamp:(double)arg3 groundAltitude:(id)arg4 fusionInfo:(id)arg5 rawHorizontalAccuracy:(double)arg6 rawCourseAccuracy:(double)arg7 coarseMetaData:(id)arg8 ;
-(void)dealloc;
