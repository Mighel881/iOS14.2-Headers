...
@class SUDownload, SUDescriptor, NSDate, SUScanOptions, NSString, NSDictionary, _SUAutoInstallOperationModel, SUManagedDeviceUpdateDelay, SUInstallPolicy, NSObject, SUCorePersistedState;
...
@property (nonatomic,retain) SUScanOptions * lastScannedDescriptorScanOptions;                          //@synthesize lastScannedDescriptorScanOptions=_lastScannedDescriptorScanOptions - In the implementation block
...
-(void)setLastScannedDescriptorScanOptions:(SUScanOptions *)arg1 ;
@end
